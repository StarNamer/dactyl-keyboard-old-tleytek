...
(defn column-offset [column] (cond
                               ...
                               (= column 1) [0 -2 0]
                               (= column 3) [0 -3 0]
                               (>= column 4) [0 -20 4]            ; original [0 -5.8 5.64]
                               :else [0 0 0]))
...
(defn thumb-br-place [shape]
  (->> shape
       ...
       (translate [-37 -13 14]))) ; original 1.5u  (translate [-12 -16 3])
(defn thumb-mr-place [shape]
  (->> shape
       ...
       (rotate (deg2rad  0) [0 0 1]) ; original 10
       (translate thumborigin)
       (translate [-58 -13 14]))) ; original 1.5u (translate [-32 -15 -2])))
...
;       )
;   (triangle-hulls   ;between bottom row to top row
...
;   (triangle-hulls ;pinky connector
...
;      (wall-brace thumb-tr-place -1 0 web-post-tl (partial left-key-place 2 0) -1 0 web-post-tr)
      (wall-brace thumb-tr-place -1 0 web-post-tl thumb-tr-place -1 1 web-post-bl)
      (wall-brace thumb-bl-place 0 1 web-post-tl thumb-bl-place -1 1 web-post-tr)
      (wall-brace thumb-bl-place -1 0 web-post-tl thumb-bl-place -1 0 web-post-bl)
...
;         (screw-insert lastcol cornerrow  bottom-radius top-radius height [-5 -10 0])
