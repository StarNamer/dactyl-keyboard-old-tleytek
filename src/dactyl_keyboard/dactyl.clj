...
(defn thumb-br-place [shape]
  (->> shape
       ...
       (translate [-32 -16 10]))) ; original 1.5u  (translate [-12 -16 3])
(defn thumb-mr-place [shape]
  (->> shape
       ...
       (rotate (deg2rad  10) [0 0 1]) ; original 10
       (translate thumborigin)
       (translate [-52 -19.5 10]))) ; original 1.5u (translate [-32 -15 -2])))
...
(defn thumb-tr-place [shape]
  (->> shape
       ...
       (rotate (deg2rad  10) [0 0 1])
       (translate thumborigin)
       (translate [-56 4 14]))) ;        (translate [-51 -25 -12])))
...
;   (for [x (range 5 ncols)] (key-wall-brace x cornerrow 0 -1 web-post-bl (dec x) cornerrow 0 -1 web-post-br))
   ...
   (wall-brace thumb-bl-place -1  0 web-post-bl thumb-bl-place  0  -1 web-post-bl)
      (wall-brace thumb-tr-place 0 1 web-post-tr thumb-tr-place 0.25 0 web-post-tr)
   ; thumb tweeners
   (wall-brace thumb-mr-place  0 -1 web-post-bl thumb-br-place  0 -1 web-post-br)
   (wall-brace thumb-br-place  0 -1 thumb-post-br (partial key-place 3 lastrow)  0 -1 web-post-bl)
    
      
      
      
   ; clunky bit on the top left thumb connection  (normal connectors don't work well) -l4u
   ; I don't understand how these work yet -tleytek
;   (bottom-hull
