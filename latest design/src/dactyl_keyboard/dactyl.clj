...
(defn column-offset [column] (cond
                               ...
                               (= column 1) [0 -3 0]
                               (= column 3) [0 -4 0]
                               (>= column 4) [0 -22 4]            ; original [0 -5.8 5.64]
                               :else [0 0 0]))

(def thumb-offsets [28 0 -20])
...
(defn thumb-mr-place [shape]
  (->> shape
       ...
       (rotate (deg2rad  0) [0 0 1]) ; original 10
       (translate thumborigin)
       (translate [-65 -10 30]))) ; original 1.5u (translate [-32 -15 -2])))
...
(def case-walls
  (union
   ...
   ; left wall
   (for [y (range 0 cornerrow)] (union (wall-brace (partial left-key-place y 1)       -1.3 0 web-post (partial left-key-place y -1) -1.3 0 web-post)
                                     (hull (key-place 0 y web-post-tl)
                                           (key-place 0 y web-post-bl)
                                           (left-key-place y  1 web-post)
                                           (left-key-place y -1 web-post))))
   (for [y (range 1 cornerrow)] (union (wall-brace (partial left-key-place (dec y) -1) -1.3 0 web-post (partial left-key-place y  1) -1.3 0 web-post)
                                     (hull (key-place 0 y       web-post-tl)
                                           (key-place 0 (dec y) web-post-bl)
                                           (left-key-place y        1 web-post)
                                           (left-key-place (dec y) -1 web-post))))
   (for [y (range cornerrow lastrow)] (union (wall-brace (partial left-key-place (dec y) -1) -1.3 0 web-post (partial left-key-place y  1) -1.3 0.3 web-post)
                                     (hull (key-place 0 y       web-post-tl)
                                           (key-place 0 (dec y) web-post-bl)
                                           (left-key-place y        1 web-post)
                                           (left-key-place (dec y) -1 web-post)
   ...
   ; thumb walls
;      (wall-brace (partial key-place 0 1) -1 0 web-post-bl thumb-tr-place -1 0 web-post-tr)
      (wall-brace thumb-bl-place -1 0 web-post-tl thumb-bl-place -1 0 web-post-bl)
      (wall-brace thumb-bl-place -1  -1 web-post-bl thumb-bl-place  -1 -1 web-post-br)
      (wall-brace thumb-tr-place -1 0 web-post-bl thumb-bl-place -1 0 web-post-tl)
      (wall-brace thumb-tr-place -1 0 web-post-bl thumb-tr-place -1 0 web-post-tl)
;      (wall-brace thumb-bl-place -1 0 web-post-tl thumb-bl-place -1 0 web-post-bl)

   ; thumb corners
   (wall-brace thumb-bl-place -1 0 web-post-bl thumb-bl-place  -1 -1 web-post-bl)
...
(def trrs-holder-position  (map + usb-holder-position [-15 2.35 0]))
...
(defn screw-insert-all-shapes [bottom-radius top-radius height]
  (union 
      ...
      (screw-insert 2 lastrow     bottom-radius top-radius height [-9 14 0])
      ...
      (screw-insert 0 lastrow           bottom-radius top-radius height [-8 -14 0])
      ))
